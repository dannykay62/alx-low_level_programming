...
/**
 * struct shah_node_s - node of sorted hash table
 * @key: key, string
 * key is unique in the hash table
 * @value: value corresponding to a key
 * @next: pointer to the next node of the list
 * @sprev: pointer to the previous element of the sorted linked list
 * @snext: pointer to the next element of the sorted list
 */
 ...
 * each cell of this array is a pointer to the first node of a linked list
 * because we want our hash table to use a chaining collision linked list
